  ...
  return (
    <div className="relative h-[calc(100vh-4rem)] w-full overflow-hidden text-white flex items-center justify-center -mt-1" ref={containerRef}>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center md:items-stretch w-full h-full max-w-screen-2xl px-4 md:px-8 z-10 relative pointer-events-none">
        ...
        {/* Left Column */}
        <div className="flex flex-col justify-start md:justify-center h-auto md:h-full w-full md:w-1/3 gap-3 md:gap-6 pointer-events-auto z-50 pt-4 md:pt-0">
          ...
          <div className="hidden md:flex items-center gap-4 mt-auto pb-8">
            ...
            <div className="flex flex-col drop-shadow-md">
              <span className="text-[10px] tracking-widest text-white/80">QUALITY ASSURED</span>
              <span className="text-sm font-bold">100% PURE HONEY</span>
            </div>
          </div>
        </div>

        {/* Right Column (Carousel) */}
        <div className="flex flex-col justify-end md:justify-center items-center md:items-end text-center md:text-right h-auto md:h-full w-full md:w-1/3 z-50 pointer-events-auto pb-6 md:pb-0 mt-auto md:mt-0">
          <div className="flex flex-col gap-4 md:gap-6 items-center md:items-end pb-2 md:pb-8">
            <div className="flex gap-3 md:gap-4">
              <div onClick={() => switchTheme('classic')} className={`cursor-pointer bg-black/20 backdrop-blur-md border ${flavor === 'classic' ? 'border-amber-400 border-2' : 'border-white/20 hover:bg-black/40'} p-2 md:p-4 pt-10 md:pt-16 rounded-2xl md:rounded-3xl flex flex-col items-center w-24 sm:w-28 md:w-32 transition-all relative shadow-xl`}>
                <img src="/honey-light.png" alt="Classic Honey" width="65" height="65" className="absolute -top-8 sm:-top-10 md:-top-10 drop-shadow-2xl pointer-events-none object-contain" />
                <span className="font-bold text-[11px] sm:text-xs md:text-sm mt-1 md:mt-2">Classic Amber</span>
                <span className="text-[9px] sm:text-[10px] md:text-xs text-white/70">Raw Honey</span>
              </div>
              <div onClick={() => switchTheme('dark')} className={`cursor-pointer bg-black/20 backdrop-blur-md border ${flavor === 'dark' ? 'border-amber-400 border-2' : 'border-white/20 hover:bg-black/40'} p-2 md:p-4 pt-10 md:pt-16 rounded-2xl md:rounded-3xl flex flex-col items-center w-24 sm:w-28 md:w-32 transition-all relative shadow-xl`}>
                <img src="/honey-dark.png" alt="Dark Forest Honey" width="75" height="75" className="absolute -top-10 sm:-top-12 md:-top-12 drop-shadow-2xl pointer-events-none object-contain" />
                <span className="font-bold text-[11px] sm:text-xs md:text-sm mt-1 md:mt-2">Dark Forest</span>
                <span className="text-[9px] sm:text-[10px] md:text-xs text-white/70">Premium Blend</span>
              </div>
            </div>
